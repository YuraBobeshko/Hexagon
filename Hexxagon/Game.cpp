...
Game::Game() : listOfPlayer({ new Player(TypeOfField(1), REAL_PLAYER), new Player(TypeOfField(2), BOT) }) {
    init();
}
...
sf::Text* Game::createText(std::string string, int size, int x, int y) {
